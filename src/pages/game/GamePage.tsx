    ...
    <div className={styles["game-page-container"]}>
      <div className={styles.left}>
        ...
        <section className={styles["detail-sections"]}>
          <GameDetailSection title="About The Game" description={gameData?.description} loading={loading}/>
          <GameDetailSection title="Minimum Requirements" description={gameData?.min_requirements} loading={loading}/>
          <GameDetailSection title="Recommended Requirements" description={gameData?.recommended_requirements} loading={loading}/>
        </section>
      </div>
      <div className={styles.right}>
        ...
        <div className={styles.details}>
          <div className={styles["detail-column"]}>
            <GameDetail title="Platforms" description={gameData?.platforms?.join(", ")} loading={loading}/>
            <GameDetail title="Genre" description={gameData?.genres?.join(", ")} loading={loading}/>
            <GameDetail title="Developers" description={gameData?.developers?.join(", ")} loading={loading}/>
          </div>
          <div className={styles["detail-column"]}>
            <GameDetail title="Rating" description={gameData?.metacritic?.toString()} loading={loading}/>
            <GameDetail title="Release Date" description={gameData?.released} loading={loading}/>
          </div>
        </div>
      </div>
    </div>
